...
final_sum = []
with os.scandir('e:/realsong/pycharmprojects/jump/practice') as lists:  # 특정경로의 파일 목록을 불러온다
    for list in lists:
        sale = read_data("e:/realsong/pycharmprojects/jump/practice\\%s" % list.name)  # 파일의 데이터를 추출한다.
