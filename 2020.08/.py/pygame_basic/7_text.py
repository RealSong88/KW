...
# 배경이미지 불러오기
background = pygame.image.load("c:/RealSong/documents/PycharmProjects/pygame_basic/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("c:/RealSong/documents/PycharmProjects/pygame_basic/character.png")
...
enemy = pygame.image.load("c:/RealSong/documents/PycharmProjects/pygame_basic/enemy.png")
