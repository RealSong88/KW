...
# 배경이미지 불러오기
background = pygame.image.load("c:/RealSong/documents/PycharmProjects/RandDice/pygame_basic/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("c:/RealSong/documents/PycharmProjects/RandDice/pygame_basic/character.png")
character_size  = character.get_rect().size # 이미지의 크기를 구해옴
character_width = character_size[0] # 캐릭터의 가로크기
character_height = character_size[1] # 캐릭터의 세로크기
character_x_pos = int(screen_width / 2) - int(character_width / 2) # 화면 가로의 절반 크기에 해당하는 곳에 위치
...
enemy = pygame.image.load("c:/RealSong/documents/PycharmProjects/RandDice/pygame_basic/enemy.png")
