...
class S(BaseHTTPRequestHandler):
    ...
    def _set_response(self, status, mine):
        self.send_response(status)
        self.send_header('Content-type', 'text/%s; charset=utf-8' % mine)
        self.end_headers()
